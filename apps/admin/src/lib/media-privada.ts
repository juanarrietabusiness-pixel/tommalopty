...
/**
 * El bucket privado, desde el panel.
 *
 * Aquí se escribe —el comprobante de un abono— y se lee: es donde se miran
 * tanto los comprobantes como las fotos de prueba de entrega. El binding se
 * declara en `wrangler.jsonc` y por eso no hay ninguna credencial que rotar.
 *
 * Este archivo está duplicado casi igual en la tienda, y es a propósito: son dos
